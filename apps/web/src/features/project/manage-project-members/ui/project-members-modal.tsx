...
export function ProjectMembersModal({ open, onClose, project, users, canManageMembers = false }: ProjectMembersModalProps) {
  ...
  const isAddTab = canManageMembers && activeTab === "add";
  const isListTab = !isAddTab;
      ...
      <div className="space-y-5">
        ...
        {isListTab ? (
          <ProjectMembersUsersList
            ...
            canRemoveUsers={canManageMembers}
